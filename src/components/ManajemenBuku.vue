  ...
  <div class="container mt-3">
    ...
    <div id="formTambah" v-if="formMode == 'create'">
        ...
        <form class="form-row"  @submit.prevent="submitAdd">
            ...
            <div class="col-2">
                <input type="submit" class="btn btn-primary ml-5" placeholder="Simpan" />
            </div>
        </form>
    </div>
    <div id="formUbah" v-if="formMode == 'edit'">
        ...
        <form class="form-row" @submit.prevent="submitChange">
            ...
            <div class="col-2">
                <input type="submit" class="btn btn-primary ml-5" placeholder="Ubah" />
            </div>
        </form>
    </div>
    <div id="daftarBuku">
        ...
        <hr/>
        <button @click="formMode = 'create'" class="btn btn-primary m-2">Tambah Buku</button>
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <button class="btn btn-danger" @click="deleteBook(bool, index)">Hapus</button>
                </td>
            </tr>
            </tbody>
        </table>
